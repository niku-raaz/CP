...
void solve(){
    ...
    while(!q.empty()){
        ...
        int valfather=a[father];


            while(1){

                int diff=abs(curr-valfather);
                if(prime[diff]){
                    curr++;
                }else{
                    break;
