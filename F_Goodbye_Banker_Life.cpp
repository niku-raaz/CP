...
void solve(){
   ...
   // vector<int> r=generateNthrow(n-1);

    //It turns out that this reduces to the following: C(n,p) is odd if and only if every bit of the binary expansion of p
// is less than or equal to the corresponding bit of the binary expansion of n
 //. This is due to Lucas.
 // odd when p<n bitbybit
