...
void dfs(int node,int par,vector<vector<int>>& g,vector<int>& dp){
...
void solve(){
    ...
    // find the leaf which is connected to maximum degree
    ...
    // asked to print first moves
    // doent mean greedy solution
    ...
    // I can take any a,b,c as first pair
    // what should be condition on that
