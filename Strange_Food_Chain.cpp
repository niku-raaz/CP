    ...
    while(k--){
        ...
        if(tt==1){
            ...
            if(rx==ry){
                ...
                // diffenrent set, so merge them

                d.par[ry]=rx;

                d.rank[ry]=(d.rank[x]-d.rank[y]+3)%3;
            ...
            if(rx==ry){
                ...
                d.rank[ry]=(d.rank[x]-d.rank[y]+4)%3;
