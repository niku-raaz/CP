...
vector<int> a(n+1),b(n+1);
    ...
    vector<int> indb(n+1,0),inda(n+1,0);
    ...
    while(lo<=hi){
        ...
        if(a[lo]==b[hi]){
            ...
            if(ind>=lo && ind<hi){
                ...
                ans.push_back({lo,ind});

                swap(inda[a[lo]],inda[a[ind]]);

                swap(indb[b[lo]],indb[b[ind]]);
                ...
                ans.push_back({hi,ind});

                swap(inda[a[hi]],inda[a[ind]]);

                swap(indb[b[hi]],indb[b[ind]]);
  ...
  //  show(b);
    ...
    for(int i=0;i<ans.size();i++){
        cout<<ans[i].first<<" "<<ans[i].second;pl;
