...
void solve(){
    ...
    while(q--){
        ...
        // I want ct2 elemnts gretaer tha k
        // ans ct1 elemnts lesser than k
        if(ct1<=totsmall && ct2<=totlarger){
          //  cout<<used1<<" "<<used2<<"     ";
            cout<<(min(used1,used2))*2+(2*abs(used1-used2))<<" ";
