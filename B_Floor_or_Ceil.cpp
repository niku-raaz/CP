...
int rec1(int x,int n,int m){
    ...
    int ans=x;
    if(n>0){
        ans=min(ans,rec1(x/2,n-1,m));
    }
    if(m>0){
        ans=min(ans,rec1((x+1)/2,n,m-1));
    }
...
int rec2(int x,int n,int m){
    ...
    int ans=0;
    if(n>0){
        ans=max(ans,rec2(x/2,n-1,m));
    }
    if(m>0){
        ans=max(ans,rec2((x+1)/2,n,m-1));
    }
