...
void solve(){
    ...
    // I want N,M st for any any matrix 
    // I can have a*b same elemnts in that
    ...
    // Now since N is coorect
    // Now I want to find minimum M

    // Its just maths Now. I must do it



    // I want B people to match among those ms
