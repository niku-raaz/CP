...
bool sbs(const pair<char,int>&a,const pair<char,int>&b){
...
void solve(){
    ...
    // can swap sp np need of DP ig
    // just need frequencies a bit
   ...
   // I need to know m1 freqs multiple of m2 fres
   ...
   string mppp="abcdefghijklmnopqrstuvwxyz";
